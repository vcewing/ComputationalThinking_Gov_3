...
#str is similar to dtypes - tells you the types of the data
#width=70 tells R that you don't want to see more than 70 characters
```
...
#table is useful for cateforical variables - shows you the frequency of values
```
...
for (x in explanans){
    ...
    #first is the independent variables, second is dependent variables
